...
endless-stack supersession and temporary-queue serialization within each tier, scene-change pause/resume, the sound
manager's cancellable playback task, and discriminant pinning across the wasm-FFI, wayland, and hardware-driver
boundaries.
