...
impl HostRenderProfiling {
    ...
    fn log_frame(
        ...
        tracing::debug!(
            ...
            taffy_build_us = context.timings.taffy_build_us,
            taffy_compute_us = context.timings.taffy_compute_us,
            paragraph_misses = context.timings.paragraph_misses,
            paragraph_entries = context.timings.paragraph_entries,
            gpu_capture_us = context.timings.gpu_capture_us,
            gpu_blit_us = context.timings.gpu_blit_us,
            gpu_dynamic_us = context.timings.gpu_dynamic_us,
