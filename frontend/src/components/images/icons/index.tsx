...
export const Deck = carbonizeSvgIcon(require('./deck.svg'), 'Deck');

export const WidgetBlockHeight = carbonizeSvgIcon(require('./widget-block-height.svg'), 'WidgetBlockHeight');
export const WidgetBlockchainData = carbonizeSvgIcon(require('./widget-blockchain-data.svg'), 'WidgetBlockchainData');
