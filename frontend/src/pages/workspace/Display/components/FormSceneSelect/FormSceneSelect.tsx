...
export interface FormSceneSelectProps {
    onClick(kind: pb.SceneKind): void;
}
    ...
    return (
        <section role="list" className={css.root}>
            <Row
                ...
                onClick={() => onClick(pb.SceneKind.combined)}
            />
            ...
            <Row
                ...
                onClick={() => onClick(pb.SceneKind.clock)}
            />
            ...
            <Row
                ...
                onClick={() => onClick(pb.SceneKind.ticker)}
            />
            ...
            <Row
                ...
                onClick={() => onClick(pb.SceneKind.pool)}
            />
            ...
            <Row
                ...
                onClick={() => onClick(pb.SceneKind.manager)}
            />
        </section>
    );
}
