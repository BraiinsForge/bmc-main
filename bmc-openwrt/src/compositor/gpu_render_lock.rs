...
fn lock_path_from_env_value(value: Option<&OsStr>) -> Option<PathBuf> {
    match value {
...
#[derive(Debug)]
pub(super) struct GpuRenderLock {
    file: Option<File>,
}
...
impl GpuRenderLock {
    ...
    pub(super) fn lock(&self, scope: &'static str) -> Result<GpuRenderLockGuard> {
...
#[must_use]
pub(super) struct GpuRenderLockGuard {
    file: Option<File>,
    scope: &'static str,
}
