...
pub(crate) fn registrar_icon(data: &[u8]) -> u16 {
...
pub(crate) fn registrar_bitmap(data: &[u8]) -> u16 {
    let ptr = RENDERER_PTR.with(Cell::get);
    assert!(
        !ptr.is_null(),
...
pub(crate) fn registrar_bitmap_nearest(data: &[u8]) -> u16 {
    let ptr = RENDERER_PTR.with(Cell::get);
    assert!(
        !ptr.is_null(),
...
pub(crate) fn registrar_mesh(data: &[u8]) -> u16 {
    let ptr = RENDERER_PTR.with(Cell::get);
    assert!(
        !ptr.is_null(),
