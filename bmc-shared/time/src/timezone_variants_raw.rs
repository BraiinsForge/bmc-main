...
//! Raw timezone variants — IANA name + POSIX TZ string.
//!
//! Sourced from openwrt/LuCI:
//! <https://github.com/openwrt/luci/blob/05c7844389e36385aa64549a3cc449b9d1a552e7/modules/luci-base/ucode/zoneinfo.uc>
//! Copyright the OpenWrt/LuCI contributors, licensed under Apache-2.0
//! (<https://github.com/openwrt/luci/blob/master/LICENSE>).
//!
//! Single source of truth for both this crate (`timezone_variant::TIMEZONE_VARIANTS`)
//! and `bmc-wasm-sdk-macros` (compile-time validation in the `tz!` macro).

/// Each entry is `(iana_name, posix_tz_string)`. Ordered as in the upstream
/// LuCI source so diffs against future updates stay reviewable.
pub const TIMEZONE_VARIANTS_RAW: &[(&str, &str)] = &[
    ("Africa/Abidjan", "GMT0"),
    ("Africa/Accra", "GMT0"),
    ...
    ("Africa/Casablanca", "XXX-2<+01>-1,0/0,J365/23"),
