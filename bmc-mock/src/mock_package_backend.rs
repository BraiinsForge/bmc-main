...
use bmc_upgrade::packages::{
    ...
    WidgetCategory, installable_widgets_from,
};
...
fn widget_catalog() -> Vec<InstallableWidget> {
    vec![
        InstallableWidget {
            ...
            subname: None,
            category: InstallableCategory::Known(WidgetCategory::Clock),
        ...
        InstallableWidget {
            ...
            category: InstallableCategory::Known(WidgetCategory::Weather),
        ...
        InstallableWidget {
            ...
            subname: None,
            category: InstallableCategory::Known(WidgetCategory::Mining),
