...
#[expect(
    ...
    reason = "_kb suffix encodes the unit and matches /proc/*/status field names"
)]
...
#[expect(
    clippy::struct_field_names,
    reason = "_kb suffix encodes the unit and matches /proc/meminfo field names"
)]
#[derive(Debug, Clone, Copy, Default)]
...
pub(crate) fn read_self_rss() -> Option<RssSample> {
