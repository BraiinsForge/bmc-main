...
mod tests {
    ...
    use super::super::background::{TlsVerificationMode, build_tls_client_config};
    use super::{
        MAX_DECODE_IMAGE_PIXELS, decode_image_rgba_limited, kv_disk_path, rgba_byte_len_limited,
        validate_kv_key, xml_lookup_text,
    };
