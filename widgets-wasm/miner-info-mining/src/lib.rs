...
//! Miner Info - Mining: one miner's own readings, with no Bitcoin-network
//! figures, so it polls the miner and nothing else.
...
pub extern "C" fn render(_delta_ms: u32) {
    ...
    let root = match panel {
        ...
        Panel::Bmm101 => face::bmm101::mining(&miner),
