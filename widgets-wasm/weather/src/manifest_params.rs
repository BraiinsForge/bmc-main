...
impl TimeZone {
    ...
    pub const ALL: &'static [Self] = &[Self::Location, Self::System];
...
bmc_wasm_sdk::impl_manifest_str_enum!(TimeZone);
...
impl Params {
    ...
    pub fn from_snapshot(snap: &snapshot::Params) -> Self {
        Self {
            location: <String as ParamRead>::read_required(snap, "location"),
            time_zone: <TimeZone as ParamRead>::read_required(snap, "time_zone"),
        }
    }
