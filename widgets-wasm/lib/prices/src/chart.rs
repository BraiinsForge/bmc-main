...
//! Sparkline geometry, shared by both ticker widgets. Free of SDK draw types so
//! it builds and unit-tests on the host; the wasm render path turns these
//! points into canvas draw commands. An independent copy of mining-info's
//! header-sparkline geometry.
